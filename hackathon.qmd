...
The aim of the hackathon is to develop a function to clean, explore and/or visualise palaeontological data. In doing this, you will also gain experience of collaborative and reproducible coding. We have prepared four project briefs for the hackathon. You and your group are free to choose whichever brief you wish to work on (first-come, first-served basis). Alternatively, you are free to work on your own project idea.
...
At the end of the hackathon, each group will give a 10 minute presentation, followed by 5 minutes of questions. In the presentation, you should include:
- Outline of the goal
...
Voting will then take place to determine the winning team.
