...
The event starts at 09:00 on the 7^th^ September 2023 and will take place in Teaching Lab 1 (126), [Kathleen Lonsdale Building, University College London](https://goo.gl/maps/CseD7br5SF9xLEQE6). See [Getting Here](/location.qmd) for more information. 
...
```{R}
#| eval: false
install.packages("deeptime", "dplyr", "extrafont", "ggplot2", "ggpubr", "maps",
                 "palaeoverse", "raster", "RColorBrewer", "rgplates", "rpaleoclim",
                 "sf", "svglite", "terra")
```
